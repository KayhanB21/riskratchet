...
def render_report_json(
    ...
    *,
    ...
    payload: dict[str, Any] = {
        ...
        # Since 0.3.0 scored TypeScript functions are mixed in here with `language: "typescript"`
        # (P20 capstone); the former separate top-level `typescript[]` array was removed.
